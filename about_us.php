...
<body style="background-color:#212529;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            ...
            <h1 style="color:white; text-shadow:2px 2px 2px gray;">Tanaya Kanchan</h1>
            <p style="color:gray;"><b>Intern at The Sparks Foundation <br> K.B.P. College of Engineering, Satara</b></p>
    </center>
